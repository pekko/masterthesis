...
\newcommand{\FDATE}{8. lokakuuta 2014}
...
The UUID is Universally Unique Indetifier, defined by RFC 4122~\cite{rfc4122}. Depending on the purpose, UUID can be time-based, name-based or random-based. As the names suggest, time-based UUIDs include creation timestamp, whereas name-based ones remain constant for the same entity, for example for the same device creating them. The name used in UUIDs can be any kind of object identifier, for instance a MAC address or a domain name.
