...
Nodes can also work in \emph{ad-hoc} mode, where they are simultaneously as an access point and as a node. However, these networks are not common, and we will not cover them in this thesis.
...
MAC addresses are presented in hexadecimal notation consisting of six two-character groups, seperated by a colon, for example ``54:26:96:d0:2c:b1''.
