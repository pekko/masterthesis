...
In Table~\ref{tab:stage_counts} there are count of SSIDs processed in every phase. We see from the table, that even though we were able to get location infromation for almost two-thirds of SSIDs, less than halfb of the locations were considered accurate enough. This is due to ambiguous SSIDs: they appear more than once and in various locations.
