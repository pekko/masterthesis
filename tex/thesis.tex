...
To manage the problem, we face it in parts. First we look for the legal status of mapping WLAN access points.

A possible directive for the case, the e-privacy directive (2002/58/EC), is not relevant. First, in the opinion of the Working Party, it is said to apply only to location data processed by telecom operators~\cite{wp29_185}. That can be read from the directive, where ``location data'' is defined in Article 2(c) as
...
According to the official opinion of the Working Party~\cite{wp29_185}, the really relevant piece of legistation is the data protection directive (1995/46/EC)~\cite{data_protection}. It states in the first article for its object that
