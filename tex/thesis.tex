...
\newcommand{\FINSTRUCTOR}{Professori Christopher Kruegel, UC Santa Barbara\\Professori Giovanni Vigna, UC Santa Barbara}
...
We verified our results by manually going through SSID lists of users marked as foreigners. Generally, we have good reasons to believe that they were correct. In many cases, there were SSIDs that appear in WiGLE's database only once, or ones that are named after local business.
