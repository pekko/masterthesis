...
However, today's threats are different from yesterday's. Thus, we hope that U.S. will update its privacy legislation to match today's environment instead of fifty-years-old. Last, we note that lawmakers should be aware of the fact, that the laws they decided may last for decades.
