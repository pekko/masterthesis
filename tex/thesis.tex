...
In Table~\ref{tab:stage_counts} there are count of SSIDs processed in every phase. We see from the table, that even though we were able to get location infromation for almost two-thirds of SSIDs, less than half of the locations were considered accurate enough. This is due to ambiguous SSIDs: they appear more than once and in various locations.

\begin{table}[h]
    \center
    \begin{tabular}{|l|c|c|}
        \hline
        Unique SSIDs                            & 8454 & 100~\% \\ \hline
        Location point for SSID                 & 5451 & 64~\%  \\ \hline
        Reasonable low uncertainty for location & 2283 & 27~\%  \\ \hline
        Google Places data                      & 1543 & 18~\%  \\ \hline
        Trustworthy Google Places data          & 1016 & 12~\%  \\ \hline
        Detailed hotel information              & 389  & 4.6~\%   \\ \hline
        Trustworthy hotel information           & 222  & 2.6~\%   \\ \hline
    \end{tabular}
