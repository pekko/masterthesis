...
Using our analysis, it is clear that there is a field containing interesting information for identifying user and his device. Some mobile devices are actively searching for WPS-enabled devices, and are sending WPS probes for that purpose.
