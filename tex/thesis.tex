...
\begin{itemize}
    \item the data subject [target] must have given his consent, or there is strong necessity such as legal obligation
...
This is a difficult question: what are ``all the means likely reasonably to be used''?. The Working Party notes that not only today's situation is enough to consider, but that also future development should be taken into account, if data is to be stored for a longer period.~\cite{wp29_136} Because there have been no legal cases for the issue, we cannot answer this question reliably.
...
\center
    \begin{tabular}{|l|c|c|}
        ...
        \hline
        Collecting SSIDs from mobile devices & Restrictions apply & Legal \\ 
        \hline
        Analyzing the collected data & Restrictions apply & Legal \\ \hline
    \end{tabular}
